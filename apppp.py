...
conn = pymysql.connect(host='localhost', user='pi@localhost', password='ap565639', port=3306,
                           db='student')
cursor = conn.cursor()
...
def status(pin,action):
    ...
    return render_template('management.html', **templateData)
...
def attendance():
    ...
    return render_template('attendance.html', labels=labels,content=content)
                    ...
                    # 6.2.2 人脸数增加 / Face cnt increase: 0->1, 0->2, ..., 1->2, ...
                        ...
                        for k in range(len(faces)):
                            ...
                            if min(self.current_frame_face_X_e_distance_list) < 0.4:
                                ...
                                sql='update student_table set attendance=出席 where student_name=%s'
                                try:
